...
void ClassTable::checkMainExists() {
	...
	} else if (!hasKeyInMap(main_meth, method_map_[Main])) {
		semant_error(inher_map_[Main]) << "No 'main' method in class Main.\n";
	}
}
...
bool ClassTable::checkClassExist(const Symbol type_defined) {
